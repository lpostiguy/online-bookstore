...
export const ProductPage: React.FC<props> = ({ livre, setShowProductPage }) => {
  ...
  return (
    <div className="rounded-xl w-full bg-slate-50 shadow-md h-auto p-4 space-y-4 pb-20">
      ...
      <div className="flex space-x-10 lg:space-x-14 xl:space-x-20 pt-4">
        <div className="bg-neutral-200 rounded-md flex justify-center items-center w-1/2 h-96">
          <img className="w-32" src={bookPlaceholder} alt="Place Holder" />
        </div>
        <div className="space-y-2 w-1/2">
          ...
          {showConfirmationPage ? (
            <div className="font-bold text-2xl text-center flex items-start h-full pt-10">
              <p>{action} effectué avec succès !</p>
            </div>
          ) : (
            <>
